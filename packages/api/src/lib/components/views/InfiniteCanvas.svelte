<script lang="ts">
	...
	let {
		...
		onupdate = () => {},
		...attributes
	}: { children?: Snippet; camera?: Camera; canPan?: boolean; onupdate?: () => void } & HTMLAttributes<HTMLElement> = $props();
...
<section {...attributes} bind:this={outer} class="outer" onwheel={zoom} onmousemove={pan} style:cursor>
